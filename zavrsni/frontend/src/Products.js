...
const Product = () => {
    ...
    useEffect(() => {
        async function getProducts (){
            ...
            const productList = await fetch("http://127.0.0.1:3001/product/products", option);
        ...
        getShades();
        getFavs();
      }, [categories, products, favs, currentShade]);
    ...
    return(
        <div className='container justify-content-center'>
            ...
            <div>
            {user.role === "admin" ? <a style={{textDecoration:"none"}} href="/categories"><button className="navBut2">Categories</button></a>: <span></span>}
            {user.role === "admin" ? <a style={{textDecoration:"none"}} href="/brands"><button className="navBut3">Brands</button></a>: <span></span>}
